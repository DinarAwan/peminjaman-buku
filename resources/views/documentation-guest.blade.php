            ...
            <div class="w-full lg:w-64 flex-shrink-0 order-2 lg:order-1">
                <div class="bg-white rounded-lg shadow-sm p-4 sm:p-6 lg:sticky lg:top-24">
                    ...
                    <nav class="space-y-1 sm:space-y-2">
                        ...
                        <a href="/" class="block py-2 px-3 text-xs sm:text-sm text-gray-600 hover:text-white hover:bg-gradient-to-r hover:from-primary hover:to-secondary rounded-lg transition-all duration-200">KembaliKe Dashboard</a>
                    </nav>
                </div>
            </div>
