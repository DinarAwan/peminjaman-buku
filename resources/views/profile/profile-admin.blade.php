...
<div class="  relative h-full max-h-screen bg-gray-50 transition-all duration-200">
    ...
    <div class="w-full px-6 mx-auto">
      ...
      style="background-image: url('{{ $user->foto_bacground ? url('foto_bacground/' . $user->foto_bacground) : asset('assets/img/curved-images/curved0.jpg') }}'); background-position-y: 50%;">
          ...
          <div class="flex-none w-auto max-w-full px-3">
            <div class="text-base ease-soft-in-out h-18.5 w-18.5 relative inline-flex items-center justify-center rounded-xl text-white transition-all duration-200">
              @if ($user->foto_profile)
                <img alt="profile_image" class="w-full shadow-soft-sm rounded-xl" src="{{ url('foto_profile').'/'.$user->foto_profile}}" >
              @else
                <img alt="profile_image" class="w-full shadow-soft-sm rounded-xl" src="{{ asset('gambar/p-profile.jpg') }}">
              @endif
              {{-- <img src="{{$user->foto_profile}}" alt="profile_image" class="w-full shadow-soft-sm rounded-xl" /> --}}
            </div>
          </div>
          <div class="flex-none w-auto max-w-full px-3 my-auto">
            <div class="h-full">
              <h5 class="mb-1">{{$user->name}}</h5>
              <p class="mb-0 font-semibold leading-normal text-sm">Admin Demen Baca   </p>
            </div>
          </div>
            ...
            <div class="relative right-0">
              <ul class="relative flex flex-wrap p-1 list-none bg-transparent rounded-xl" nav-pills role="tablist">
                <li class="z-30 flex-auto text-center">
                  <a class="z-30 block w-full px-0 py-1 mb-0 transition-all border-0 rounded-lg ease-soft-in-out bg-inherit text-slate-700" nav-link active href="/edit-profile-admin">
          ...
          <div class="flex flex-wrap items-center -mx-3 lg:justify-between">
            <div class="w-full max-w-full px-3 mt-0 mb-6 shrink-0 lg:mb-0 lg:w-1/2 lg:flex-none">
              <div class="leading-normal text-center text-sm text-slate-500 lg:text-left">
                ...
                <a href="https://dinarawan.github.io/dinar-awan/" target="_blank" class="font-semibold text-slate-700">Awanzz Tim</a>
                for a better web.
              </div>
            </div>
            <div class="w-full max-w-full px-3 mt-0 shrink-0 lg:w-1/2 lg:flex-none">
              <ul class="flex flex-wrap justify-center pl-0 mb-0 list-none lg:justify-end">
                <li class="nav-item">
                  <a href="https://dinarawan.github.io/dinar-awan/" target="_blank" class="block px-4 pt-0 pb-1 font-normal transition-colors ease-soft-in-out text-sm text-slate-500">Awanzz Tim</a>
                </li>
                <li class="nav-item">
                  <a href="#" class="block px-4 pt-0 pb-1 font-normal transition-colors ease-soft-in-out text-sm text-slate-500">About Us</a>
                </li>
                <li class="nav-item">
                  <a href="#" class="block px-4 pt-0 pb-1 font-normal transition-colors ease-soft-in-out text-sm text-slate-500">Blog</a>
                </li>
                <li class="nav-item">
                  <a href="#" class="block px-4 pt-0 pb-1 pr-0 font-normal transition-colors ease-soft-in-out text-sm text-slate-500">License</a>
                </li>
              </ul>
            </div>
          </div>
