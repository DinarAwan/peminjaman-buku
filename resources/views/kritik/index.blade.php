...
<div class="max-w-4xl mx-auto p-5">
    <div class="text-center mb-8">
        ...
        <p class="text-gray-600 text-lg mb-6">
            Form Kritik dan saran ini berguna untuk mengevaluasi kritik dan saran anda terhadap Demen Baca
        </p>
    </div>
    ...
    <div class="bg-white rounded-3xl shadow-xl border border-gray-200 overflow-hidden">
        <div class="h-96 overflow-y-auto p-6 bg-gradient-to-b from-gray-50 to-white" id="chatMessages">
            <div class="text-center text-gray-500 italic py-12" id="welcomeMessage">
                <div class="inline-flex items-center gap-2 bg-white px-6 py-3 rounded-full shadow-sm border">
                    👋 <span>Masukan Kritik/Saran apa saja ke form ini dan akan kami evaluasi secepat mungkin</span>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white border-t border-gray-200 p-6">
            <form id="formAI" method="post" action="/kirim-kritik">
                @csrf
                <div class="flex items-end gap-3">
                    <div class="flex-1 relative">
                        <textarea 
                            ...
                            id="pertanyaan"
                            rows="1"
                            placeholder="Ketik kritik dan saran kesini..."
