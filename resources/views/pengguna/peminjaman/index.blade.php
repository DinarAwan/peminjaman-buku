        ...
        <div class="w-1/4 px-2 mb-4">
            <div class="relative flex flex-col min-w-0 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                ...
                <div class="flex-auto p-4 pt-9 mt-9 text-center">
                    ...
                    <a class="inline w-1/2 px-1 py-3 my-2 font-bold text-center text-white uppercase align-middle transition-all ease-in border-0 rounded-lg select-none shadow-soft-md bg-150 bg-x-25 leading-pro text-xs bg-gradient-to-tl from-purple-700 to-pink-500 hover:shadow-soft-2xl hover:scale-102" href="/detail-buku">Detail</a>
                    <button type="submit" name="buku_id" value="{{ $item->id }}" class="inline-block w-1/2 px-1 py-3 my-2 font-bold text-center text-white uppercase align-middle transition-all ease-in border-0 rounded-lg select-none shadow-soft-md bg-150 bg-x-25 leading-pro text-xs bg-gradient-to-tl from-purple-700 to-pink-500 hover:shadow-soft-2xl hover:scale-102">Pinjam</button>
                </div>
            </div>
        </div>
        @endforeach
